Sub MakeCalendar()
  ...
  'weekdays(1) = UCase(Left(WeekdayName(1), 1))
  
  weekdays(1) = UCase(Left(WeekdayName(1, True, vbMonday), 1))
  weekdays(2) = UCase(Left(WeekdayName(2, True, vbMonday), 1))
  weekdays(3) = UCase(Left(WeekdayName(3, True, vbMonday), 1))
  weekdays(4) = UCase(Left(WeekdayName(4, True, vbMonday), 1))
  weekdays(5) = UCase(Left(WeekdayName(5, True, vbMonday), 1))
  weekdays(6) = UCase(Left(WeekdayName(6, True, vbMonday), 1))
  weekdays(7) = UCase(Left(WeekdayName(7, True, vbMonday), 1))
  ...
  For i = 1 To monthRows
    For j = 1 To monthCols
      ...
      var_monthCell.Value = Application.Proper(var_monthCell.Text)
      ...
      ' Range(Cells(monr + 1, monc), Cells(monr + 1, monc)) = "w"
  ...
  If CreateMonthsSheet And Not HexValues Then
    ...
    ActiveSheet.Name = CStr(var_year) & "-Months"
